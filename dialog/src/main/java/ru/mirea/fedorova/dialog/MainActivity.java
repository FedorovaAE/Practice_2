...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickProgressDialog(View view){
        ...
        dialogFragment.setTitle("Сообщение");
        dialogFragment.setMessage("Загрузка");
        dialogFragment.setButton(Dialog.BUTTON_POSITIVE,"Ожидайте",new DialogInterface.OnClickListener(){
            @Override
